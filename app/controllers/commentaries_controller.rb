class CommentariesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @commentary.update(commentary_params)
        format.html { redirect_to commentary_url(@commentary), notice: "Commentary was successfully updated." }
  ...
  private
    ...
    def commentary_params
      params.require(:commentary).permit(:comment, :is_reported, :is_masked)
    end
end
