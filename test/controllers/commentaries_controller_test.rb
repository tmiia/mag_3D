...
class CommentariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create commentary" do
    assert_difference("Commentary.count") do
      post commentaries_url, params: { commentary: { comment: @commentary.comment, is_masked: @commentary.is_masked, is_reported: @commentary.is_reported } }
    end
  ...
  test "should update commentary" do
    patch commentary_url(@commentary), params: { commentary: { comment: @commentary.comment, is_masked: @commentary.is_masked, is_reported: @commentary.is_reported } }
